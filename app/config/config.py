...
class CeleryConfig:
    ...
    task_routes: Dict[str, str] = field(default_factory=lambda: {"process_file": "pipeline_processing"})
...
class TavilySearchConfig:
    ...
    allowed_domains: List[str] = field(default_factory=lambda: ["https://www.siemens.com", "https://www.mitsubishi-electric.vn", "https://www.se.com/", "https://udata.ai/"])
...
class ChunkConfig:
    ...
    markdown_headers: List[Tuple[str, str]] = field(default_factory=lambda: [("#", "header1"), ("##", "header2"), ("###", "header3")])
