...
class SkillExecutionArtifact(Base):
    """Stores output files generated by skill executions with persistent blob URLs."""
    __tablename__ = "SkillExecutionArtifact"
    ...
    conversation_id = Column(
        Integer, ForeignKey("Conversation.id", ondelete="CASCADE"), index=True, nullable=False
    )
    message_id = Column(
        Integer, ForeignKey("ConversationMessage.id", ondelete="CASCADE"), index=True, nullable=True
    )
    skill_id = Column(
        Integer, ForeignKey("AgentSkill.id", ondelete="SET NULL"), index=True, nullable=True
    )
    sandbox_index = Column(Integer, nullable=True)
...
class SkillExecutionArtifactResponse(BaseModel):
    ...
    skill_id: Optional[int] = Field(None, description="Skill ID that generated this artifact")
    file_name: str = Field(..., description="Original file name")
    blob_path: str = Field(..., description="Permanent blob storage path")
